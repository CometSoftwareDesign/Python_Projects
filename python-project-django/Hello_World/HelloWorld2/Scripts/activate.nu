...
let virtual-env = "C:\python-project-django\Hello_World\HelloWorld2"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\python-project-django\Hello_World\HelloWorld2\Scripts\deactivate.nu"
