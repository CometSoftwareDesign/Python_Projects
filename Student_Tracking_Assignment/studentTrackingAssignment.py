#this is a student tracking assignment using
#python,sqlite3 and tkinter. This is meant to showcase my ability
#of using these systems to create a small dB with student data and be able
#to create a gui that can access the dB, cycle through the data, add new students
#and delete old students.

#this was created August 5 2021 by Henry Lee for The Tech Academy
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        filemenu.add_command(label="Exit", underline=1,accelerator="Ctrl+Q",command= lambda:student_Tracking_Functions.ask_quit(self))
        ...
        helpmenu.add_separator()
        helpmenu.add_command(label="About This Student Tracking") # add_command is a child menubar item of the add_cascde parent item
