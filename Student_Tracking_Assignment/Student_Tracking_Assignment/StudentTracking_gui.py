...
#this is the gui module for the python student trracking
...
#the following is the label being created
       ...
       self.lbl_CurrentCourse.grid(row = 4,column= 0, padx=(27,0), pady=(10,0),sticky = N+W)

       self.lbl_phone = tk.Label(self.master,text = 'Phone: ')
       self.lbl_phone.grid(row = 6,column= 0, padx=(27,0), pady=(10,0),sticky = N+W)
...
#the following is the text imput just above the label
       ...
       self.txt_CurrentCourse.grid(row = 5, column= 0, rowspan=1, columnspan=2, padx=(30,40), pady=(0,0),sticky = N+E+W)     


       self.txt_phone = tk.Entry(self.master,text = '')
       self.txt_phone.grid(row = 7, column= 0, rowspan =1, columnspan=2, padx=(30,40), pady=(0,0),sticky = N+E+W)


       self.txt_email = tk.Entry(self.master,text = '')
       self.txt_email.grid(row = 9, column = 0, rowspan=1, columnspan =2, padx=(30,40), pady=(0,0),sticky = N+E+W)
